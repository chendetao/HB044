...
struct FlashMemory
{
	...
	unsigned short lcd_level;            /** LCD亮度控制 */
...
#define TASK_FLASH_UPDATE_CONFIG_EVT 				0x00000010
#define TASK_FLASH_QUEUE_PUT_EVT        			0x00000020
#define TASK_FLASH_RESET_EVT            			0x00000040

#define TASK_FLASH_MAKE_TO_DEFAULT_EVT     			0x00000100
#define TASK_FLASH_LOAD_CONFIG_EVT                  0x00000200

#define TASK_FLASH_PUT_BP_EVT                       0x00000400

extern unsigned char taskFlashTaskId;
extern unsigned long taskFlash( unsigned char task_id, unsigned long events );
extern void taskFlashInit( unsigned char task_id );
