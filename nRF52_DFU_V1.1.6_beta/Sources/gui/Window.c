...
struct window_struct window[] = 
{
	...
	[2] = {2, 0, 0, 0, 1, win_sport_proc},
	[3] = {3, 0, 0, 0, 1, win_hr_proc},
	[4] = {4, 0, 0, 0, 1, win_more_proc},
	[5] = {5, 0, 0, 0, 0, win_sleep_proc},
	[6] = {6, 0, 0, 0, 0, win_alarm_proc},
	[7] = {7, 0, 0, 0, 0, win_camera_proc},
	[8] = {8, 0, 0, 0, 0, win_findphone_proc},
	[9]=  {9, 0, 0, 0, 0, win_info_proc},
	[10]= {10,0, 0, 0, 1, win_shutdown_proc},
	[11]= {11,0, 0, 0, 0, win_notify_proc},
};


unsigned char win_current;
unsigned short win_ticks;
const unsigned char winCnt = SIZEOF(window);

unsigned char win_stack[4];
...
void window_push( unsigned char wid )
{
	win_stack[current_idx++] = wid;
}

int window_pop( unsigned char *wid )
{
	if ( current_idx > 0 )
	{
