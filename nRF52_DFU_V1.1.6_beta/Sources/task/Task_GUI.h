...
#define TASK_GUI_STOP_SPORT_EVT          0x00020000
#define TASK_GUI_SYS_POWEROFF_EVT        0x00040000


#define TASK_GUI_LCD_CONFIG_DELAY_EVT    0x00080000

extern unsigned char taskGUITaskId;

extern unsigned long taskGUI( unsigned char task_id, unsigned long events );
extern void taskGUIInit( unsigned char task_id );
