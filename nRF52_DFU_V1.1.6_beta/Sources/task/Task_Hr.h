...
#define TASK_HR_AUTO_SAVE_EVT           0X00000200

#define TASK_HR_INIT_EVT                0x00000400
#define TASK_HR_DATA_PROCESSING_EVT     0x00000800

extern int to_close;
extern unsigned char last_hr;
extern unsigned long need_mTicks;

extern unsigned char taskHrTaskId;
extern unsigned long taskHr( unsigned char task_id, unsigned long events );
extern void taskHrInit( unsigned char task_id );
