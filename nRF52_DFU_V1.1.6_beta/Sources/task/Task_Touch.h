...
extern unsigned char taskTouchTaskId;


extern unsigned long taskTouch( unsigned char task_id, unsigned long events );
extern void taskTouchInit( unsigned char task_id );
