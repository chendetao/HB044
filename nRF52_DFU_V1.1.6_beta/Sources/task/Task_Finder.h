...
extern unsigned char taskFinderTaskId;

extern unsigned long taskFinder( unsigned char task_id, unsigned long events );
extern void taskFinderInit( unsigned char task_id );
