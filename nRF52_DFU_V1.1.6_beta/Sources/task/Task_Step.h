...
extern unsigned char taskStepTaskId;

extern void load_pedometer(unsigned long last_pedometer);

extern unsigned long taskStep( unsigned char task_id, unsigned long events );
extern void taskStepInit( unsigned char task_id );
