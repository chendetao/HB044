...
#define TASK_BLE_SYNC_COMFIRM_EVT            0x00002000


extern unsigned char taskBleTaskId;

extern unsigned long taskBle( unsigned char task_id, unsigned long events );
extern void taskBleInit( unsigned char task_id );
