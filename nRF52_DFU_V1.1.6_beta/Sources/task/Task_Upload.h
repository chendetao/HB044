...
extern unsigned char taskUploadTaskId;

extern unsigned long taskUpload( unsigned char task_id, unsigned long events );
extern void taskUploadInit( unsigned char task_id );
