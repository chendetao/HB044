...
#define TASK_MOTOR_TEST_EVT 		 0x00000020

extern unsigned char taskMotorTaskId;

extern unsigned long taskMotor( unsigned char task_id, unsigned long events );
extern void taskMotorInit( unsigned char task_id );
